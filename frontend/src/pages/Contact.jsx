    ...
    <div className="bg-white text-slate-800 min-h-screen font-sans antialiased">
      ...
      <div className="relative w-full h-[85vh] flex items-center justify-start overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full space-y-6 text-white">
          ...
          <p className="text-gray-200 max-w-md leading-relaxed text-sm md:text-base">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-xl font-medium tracking-wide hover:bg-emerald-700 transition-all shadow-lg hover:shadow-emerald-900/20 active:scale-95"
          >
            <Phone className="w-4 h-4" /> Call +91-97605 00048
          </a>
        </div>
      </div>
