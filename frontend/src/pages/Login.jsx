...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white text-stone-800 font-sans overflow-hidden relative">
      ...
      <div className="absolute inset-0 bg-black/40 md:hidden z-0" />
        ...
        <div className="w-full max-w-md bg-white/10 md:bg-transparent backdrop-blur-xl md:backdrop-blur-none p-8 rounded-2xl border border-white/20 md:border-none shadow-2xl md:shadow-none transition-all duration-500">
          ...
          <form onSubmit={onSubmitHandler} className="space-y-5">
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-out ${currentState === 'Login' ? 'max-h-0 opacity-0 mb-0' : 'max-h-20 opacity-100 mb-4'}`}>
              <label className="block text-xs font-semibold text-stone-200 md:text-stone-700 uppercase tracking-wider mb-1.5">Full Name</label>
              <div className="relative flex items-center">
                <User className="absolute left-3.5 text-stone-300 md:text-stone-400 w-5 h-5" />
                <input 
            ...
            {/* Email Field Input */}
            <div>
              <label className="block text-xs font-semibold text-stone-200 md:text-stone-700 uppercase tracking-wider mb-1.5">Email Address</label>
              <div className="relative flex items-center">
            ...
            <div className="flex justify-between items-center text-xs pt-1">
              <p className="text-stone-300 md:text-stone-500 hover:text-white md:hover:text-[#061b0e] cursor-pointer transition-colors underline underline-offset-4">
                Forgot your password?
              </p>
              {currentState === 'Login' ? (
                <p onClick={() => setCurrentState('Sign Up')} className="text-[#b0cfad] md:text-[#4a6549] font-medium hover:underline cursor-pointer transition-all">
                  Create account
                </p>
              ) : (
                <p onClick={() => setCurrentState('Login')} className="text-[#b0cfad] md:text-[#4a6549] font-medium hover:underline cursor-pointer transition-all">
                  Login Here
                </p>
              )}
            </div>
            ...
            <button 
              type="submit" 
              className="w-full py-3.5 mt-4 bg-white text-[#061b0e] md:bg-[#061b0e] md:text-white hover:bg-stone-100 md:hover:bg-[#13301d] font-semibold md:font-medium tracking-wide rounded-xl shadow-md transition-all active:scale-[0.99] flex items-center justify-center gap-2 group"
            >
...
//   return (
//     <div 
//       className="min-h-screen w-full flex bg-[#f9faf7] md:bg-none bg-cover bg-center text-stone-800 font-sans overflow-hidden relative"
//       style={{ backgroundImage: `url(${plant})` }}
//     >
//       {/* Dark overlay specifically for mobile backdrop legibility */}
//       <div className="absolute inset-0 bg-black/40 md:hidden z-0" />
...
//       {/* Right Column: Authentication Form Layout */}
//       <div className="w-full md:w-[55%] lg:w-[50%] flex items-center justify-center p-4 sm:p-12 relative z-10">
...
//         {/* Glassmorphic Form Container */}
//         <div className="w-full max-w-md bg-white/10 md:bg-white/0 backdrop-blur-xl md:backdrop-blur-none p-8 rounded-2xl border border-white/20 md:border-none shadow-2xl md:shadow-none transition-all duration-500">
